...
namespace testing_program
{
    public partial class form_create_new_people_for_edu : Form
    {
        ...
        {
            string create_new_People_for_edu_Query_sql = "INSERT INTO People_for_edu (FIO,Birthday,id_sex,id_education,id_profession,id_qualification,id_family,Date_start_work,extra) VALUES ('" + tb_FIO.Text + "','" + dtp_birthday.Value.Date +"','"+cb_sex.SelectedValue +"','"+ cb_education.SelectedValue+"','"+cb_profession.SelectedValue+"','"+cb_qualification.SelectedValue+"','"+cb_family.SelectedValue+"','"+dtp_date_start_work.Value.Date+"','"+rtb_extra.Text+ "');";
